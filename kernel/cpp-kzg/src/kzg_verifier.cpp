// PolyGuard C++20 KZG Polynomial Commitment Verifier for EIP-4844 / Polygon Rollup Blobs
// Language: C++20
// License: MIT
...
extern "C" {
    bool polyguard_c_verify_kzg(
        const uint8_t* commitment_48b,
        const uint8_t* z_32b,
        const uint8_t* y_32b,
        const uint8_t* proof_48b
    ) {
        polyguard::kzg::KZGBlobVerifier verifier;
        polyguard::kzg::KZGCommitment comm{};
        polyguard::kzg::Bytes32 z{}, y{};
        polyguard::kzg::KZGProof prf{};
