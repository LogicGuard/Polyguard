...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'live-assistant', label: 'AI Specialist', icon: MicIcon, component: LiveAssistantView },
  {
    ...
    subItems: [
      {
        id: 'kernel-repo',
        label: 'Git Polyglot Codebase',
        icon: CpuIcon,
        component: KernelRepositoryView,
      },
      {
        id: 'smart-contract-auditor',
        label: 'Smart Contract Auditor',
        icon: AuditorIcon,
        component: SmartContractAuditorView,
      },
      {
        id: 'smart-contract-scanner',
        label: 'Contract Scanner',
        icon: ShieldCheckIcon,
        component: ContractAnalysisView,
      },
      {
        id: 'dapp-certification',
        label: 'DApp Certification',
        icon: DAppIcon,
        component: DAppCertificationView,
      },
    ],
  },
  {
    ...
    subItems: [
      ...
      {
        id: 'smart-contract-firewall',
        label: 'Smart Contract Firewall',
        icon: FirewallIcon,
        component: SmartContractFirewallView,
      },
      {
        id: 'on-chain-monitor',
  ...
  },
  {
    ...
    subItems: [
      ...
      },
      {
        id: 'user-behavior',
        label: 'User Behavior',
        icon: UserBehaviorIcon,
        component: UserBehaviorPredictorView,
      },
    ...
    subItems: [
      {
        ...
        icon: BridgeIcon,
        component: BridgeSecurityView,
      },
      {
        id: 'staking-analysis',
        label: 'Staking Analysis',
        icon: StakingIcon,
        component: StakingAnalysisView,
      },
      {
        id: 'quantum-security',
        label: 'Quantum Security',
        icon: QuantumIcon,
        component: QuantumSecurityView,
      },
      { id: 'zk-compliance', label: 'ZK Compliance', icon: ZKIcon, component: ZKComplianceView },
      {
        ...
        icon: ComplianceIcon,
        component: RegulatoryComplianceView,
      },
    ],
  },
  {
    ...
    subItems: [
      { id: 'gas-optimizer', label: 'Gas Optimizer', icon: GasIcon, component: GasOptimizerView },
      {
        ...
        component: PerformanceOptimizerView,
      },
    ],
  },
  {
