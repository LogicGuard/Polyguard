    ...
    <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-500 font-mono mt-1 uppercase">
              SOC_V3 // Active Countermeasures // Threat Neutralization
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="p-6 bg-[#080808] border-white/10 relative overflow-hidden">
          ...
          <h3 className="text-[10px] font-mono text-gray-600 uppercase font-black mb-6">
            Active_Interceptors
          </h3>
        ...
        <Card className="p-6 bg-[#080808] border-white/10">
          ...
          <div className="text-4xl font-mono font-black text-blue-400 mb-2">
            8.2<span className="text-lg text-gray-600">/100</span>
          </div>
          <p className="text-[10px] text-green-500 font-mono uppercase tracking-widest">
            Network Risk: Nominal
          </p>
        </Card>
      </div>
        ...
        <Card className="lg:col-span-8 p-0 bg-[#050505] overflow-hidden border-white/10 h-96 flex flex-col">
          ...
          <div className="flex-1 p-8 flex items-center justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 text-center max-w-md">
              ...
              <h4 className="text-white font-mono text-xs uppercase tracking-[0.5em] mb-3">
                Monitoring_Signal_Anomalies
              </h4>
              <p className="text-[9px] text-gray-600 font-mono uppercase leading-relaxed">
                The AI Shield is actively monitoring mempool transitions and ZK-proof generation for
                outlier signatures...
              </p>
            </div>
          </div>
