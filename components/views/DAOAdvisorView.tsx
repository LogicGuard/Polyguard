      ...
      <div className="flex items-center gap-3 mb-6 flex-shrink-0">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 font-mono">
            Proposal Forensics // Strategic Impact Simulation
          </p>
        </div>
      </div>
        ...
        <div className="lg:col-span-5 flex flex-col gap-4 overflow-hidden">
          <Card className="flex-1 flex flex-col bg-[#080808] border-white/10 p-0 overflow-hidden">
            <div className="p-3 border-b border-white/10 bg-[#0A0A0A] flex justify-between items-center">
              ...
              <span className="text-[8px] text-blue-500 font-mono uppercase">
                Length: {proposal.length} chars
              </span>
            </div>
            ...
            {isLoading ? (
              <Card className="flex-1 flex flex-col items-center justify-center bg-[#050505] border-white/10 p-12 text-center">
                ...
                <h3 className="text-sm font-mono text-white uppercase tracking-[0.5em] mb-2">
                  Analyzing_Governance_Graph
                </h3>
                <p className="text-[9px] font-mono text-gray-600 uppercase">
                  Calculating vector offsets and economic equilibrium points...
                </p>
              </Card>
            ) : result ? (
              <motion.div
              ...
              <div className="flex-1 flex flex-col items-center justify-center border border-white/5 border-dashed bg-white/[0.01] rounded-sm p-12 text-center">
                ...
                <p className="text-[10px] font-mono text-gray-700 mt-2 uppercase">
                  Provide proposal text to activate the governance simulation kernel.
                </p>
              </div>
            )}
          </AnimatePresence>
