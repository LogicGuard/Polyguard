...
interface SlideData {
  ...
  comparison?: { metric: string; polyguard: string; traditional: string }[];
}
...
const SLIDES: SlideData[] = [
  {
    ...
    content:
      'PolyGuard is the first autonomous security kernel engineered to protect $150B+ in cross-chain liquidity across the fully decentralized Polygon AggLayer ecosystem.',
  ...
  },
  {
    ...
    content:
      "In the modular future, finality times are near-zero. The gap between exploit signature and detection has become the primary vector for institutional losses. Static audits can't keep up with modular execution.",
    icon: ActivityIcon,
    color: 'text-red-500',
    layout: 'stats',
    stats: [
  ...
  },
  {
    ...
    content:
      'Our proprietary kernel performs deep opcode-level inference on every state transition. We identify malicious intent before a transaction ever hits the block using high-fidelity vector mapping.',
    icon: CpuIcon,
    color: 'text-blue-400',
    layout: 'visualizer',
  },
  {
    ...
    content:
      'The industry-standard for smart contract safety. Capable of scanning 25M+ lines of Solidity code with 96.8% precision in vulnerability detection across ZK-circuits.',
    icon: AuditorIcon,
  ...
  },
  {
    ...
    content:
      'A distributed firewall network for Polygon CDK chains. It simulates and quarantines malicious multicalls in under 350ms, neutralizing reentrancy at the source.',
    icon: FirewallIcon,
    color: 'text-red-400',
    layout: 'grid',
    features: [
  ...
  },
  {
    ...
    content:
      'Deep-dive identities and provenance across the AggLayer. We provide institutional-grade dossier reports for every active address and ZK-rollup cluster.',
    icon: WalletIcon,
  ...
  },
  {
    ...
    content:
      'Monitoring 4,096 sentinel nodes globally. We ensure the uptime and integrity of the infrastructure that powers the value layer across all Polygon L2 clusters.',
    icon: GlobeIcon,
    color: 'text-cyan-400',
    layout: 'visualizer',
  },
  {
    ...
    subtitle: 'PolyGuard vs. Legacy Scanners',
    content:
      'Speed and depth of analysis are our ultimate moats. We move at the speed of the network, not the speed of the auditor. Built for the modular 2026 future.',
    icon: ZapIcon,
    ...
    comparison: [
      {
        ...
        polyguard: '350ms (Real-time)',
        traditional: '14 Days (Manual)',
      },
      { metric: 'Analysis Depth', polyguard: 'Heuristic Opcode', traditional: 'Pattern Static' },
      {
        metric: 'AggLayer Support',
        polyguard: 'Native Cluster',
        traditional: 'None / Bridge-only',
      },
      { metric: 'Response Type', polyguard: 'Autonomous Block', traditional: 'Post-Exploit Alert' },
    ],
  },
  {
    id: 9,
    ...
    content:
      'From alpha ingestion to full sovereign OS decentralization. We are building the permanent security layer of Web3.',
    icon: ClockIcon,
    color: 'text-blue-500',
    layout: 'roadmap',
  },
  {
    ...
    content:
      'Seeking strategic partners to scale our heuristic node network and establish PolyGuard as the default security module for institutional chains.',
    icon: StarIcon,
    color: 'text-white',
    layout: 'hero',
  },
        ...
        return (
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16 h-full overflow-hidden">
            <div className="w-full lg:w-3/5 space-y-6">
              <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
                <div className="inline-flex items-center gap-2 px-2.5 py-1 bg-white/5 border border-white/10 rounded-sm mb-4">
                  ...
                  <span
                    className={`text-[8px] font-mono ${slide.color} font-black uppercase tracking-[0.3em]`}
                  >
                    // {slide.tag}
                  </span>
                </div>
                <h1 className="text-3xl lg:text-5xl font-black text-white leading-[0.9] tracking-tighter uppercase mb-6">
                  {slide.title.split(' ').map((word, i) => (
                    <span
                      key={i}
                      className={i === slide.title.split(' ').length - 1 ? slide.color : ''}
                    >
                      {word}{' '}
                    </span>
                  ))}
            ...
            <div className="w-full lg:w-2/5 flex justify-center relative">
              <div
                className={`absolute inset-0 ${slide.color.replace('text', 'bg')}/10 blur-[120px] rounded-full animate-pulse`}
              ></div>
              <motion.div
              ...
              >
                <slide.icon
                  className={`w-48 h-48 lg:w-60 lg:h-60 ${slide.color} opacity-30 blur-2xl absolute inset-0 scale-125`}
                />
                <slide.icon
                  className={`w-48 h-48 lg:w-60 lg:h-60 ${slide.color} relative z-10 drop-shadow-[0_0_30px_rgba(123,63,228,0.4)]`}
                />
              </motion.div>
            </div>
          </div>
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {slide.stats?.map((s, i) => (
                  <div
                    key={i}
                    className="p-6 bg-[#0C0C0C] border border-white/5 group hover:border-red-500/20 transition-all relative overflow-hidden"
                  >
                    <div className="absolute top-0 left-0 w-1 h-full bg-red-500/5 group-hover:bg-red-500/20 transition-all"></div>
                    <div className="text-[8px] font-mono text-gray-600 uppercase mb-3 font-black tracking-widest">
                      {s.label}
                    </div>
            ...
            <div className="lg:col-span-5 h-[350px] relative bg-black border border-white/5 rounded-none overflow-hidden flex items-center justify-center p-8">
              ...
              <div className="text-center relative z-10 space-y-4">
                ...
                <div className="space-y-1">
                  <div className="text-[9px] font-mono text-red-500 font-black uppercase tracking-[0.3em] animate-pulse">
                    Critical_Exploit_Vector
                  </div>
                  <div className="text-[7px] font-mono text-gray-700 uppercase tracking-widest font-black">
                    Mempool_Calibration_Buffer_Overrun
                  </div>
                </div>
              </div>
            </div>
        ...
        return (
          <div className="space-y-10 h-full flex flex-col justify-center overflow-hidden">
            <div className="max-w-4xl space-y-2">
              <span
                className={`text-[8px] font-mono ${slide.color} font-black uppercase tracking-[0.4em] border-b border-white/10 pb-1`}
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {slide.features?.map((f, i) => (
                <Card
                  key={i}
                  className="p-6 bg-white/[0.01] border-white/5 hover:border-white/20 transition-all group relative overflow-hidden flex flex-col justify-between h-[210px]"
                >
                  ...
                  <div
                    className={`p-2.5 bg-white/5 border border-white/10 rounded-sm w-fit group-hover:${slide.color.replace('text', 'bg')} group-hover:text-black transition-all duration-300`}
                  >
                    {f.icon ? (
                  ...
                  <div className="space-y-1 relative z-10">
                    ...
                    <p className="text-[9px] text-gray-500 font-mono leading-relaxed uppercase tracking-wider">
                      {f.desc}
                    </p>
                  </div>
                  <div className="w-full h-0.5 bg-white/5 mt-4 overflow-hidden">
                    <motion.div
                      className={`h-full ${slide.color.replace('text', 'bg')}`}
                      initial={{ width: 0 }}
          ...
          <div className="space-y-10 h-full flex flex-col justify-center max-w-5xl mx-auto overflow-hidden">
            <div className="text-center space-y-3">
              ...
              <div className="flex items-center justify-center gap-3">
                ...
                <p className="text-gray-500 text-[8px] uppercase tracking-[0.4em] font-mono whitespace-nowrap">
                ...
                <table className="w-full text-left font-mono border-collapse min-w-[600px]">
                  <thead>
                    <tr className="border-b border-white/10 bg-white/[0.03]">
                      <th className="p-5 text-[9px] text-gray-500 uppercase tracking-widest font-black">
                        Strategic_Metric
                      </th>
                      <th className="p-5 text-[9px] text-gray-500 uppercase tracking-widest text-center font-black">
                        Legacy Auditor
                      </th>
                      <th className="p-5 text-[9px] text-polygon-purple-light uppercase tracking-widest text-center bg-polygon-purple/5 font-black border-l border-white/10">
                        PolyGuard_v4
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {slide.comparison?.map((row, i) => (
                      ...
                      >
                        <td className="p-5 text-gray-400 font-bold uppercase text-[10px]">
                          {row.metric}
                        </td>
                        <td className="p-5 text-gray-600 text-center text-[10px] opacity-70">
                          {row.traditional}
                        </td>
      ...
      case 'roadmap':
        return (
          <div className="h-full flex flex-col justify-center overflow-hidden">
            <h2 className="text-5xl lg:text-7xl font-black text-white uppercase mb-16 tracking-tighter text-center">
              Execution <span className="text-blue-500">2026</span>
            </h2>
                ...
                {[
                  {
                    q: 'Q1_2026',
                    label: 'Alpha Cluster',
                    desc: 'Heuristic kernel ingestion.',
                    status: 'done',
                  },
                  {
                    q: 'Q2_2026',
                    label: 'Sentry Nodes',
                    desc: '4,096 verification nodes.',
                    status: 'active',
                  },
                  {
                    q: 'Q3_2026',
                    label: 'Shield Protocol',
                    desc: 'Unified AggLayer firewall.',
                    status: 'pending',
                  },
                  {
                    q: 'Q4_2026',
                    label: 'Sovereign OS',
                    desc: 'Full decentralization.',
                    status: 'pending',
                  },
                ].map((item, i) => (
                  <motion.div
                  ...
                  >
                    <div
                      className={`w-8 h-8 rounded-none rotate-45 mx-auto mb-6 border transition-all duration-500 ${
                        item.status === 'done'
                          ? 'bg-blue-500 border-blue-400'
                          : item.status === 'active'
                            ? 'bg-black border-blue-500 animate-pulse'
                            : 'bg-black border-white/10'
                      } flex items-center justify-center shadow-[0_0_15px_rgba(59,130,246,0.2)]`}
                    >
                      {item.status === 'done' && (
                        <CheckIcon className="w-4 h-4 text-white -rotate-45" />
                      )}
                    </div>
                    <h4 className="text-blue-500 font-black font-mono text-[10px] mb-2">
                      {item.q}
                    </h4>
                    <div className="text-white font-bold uppercase text-[11px] mb-2 tracking-tighter">
                      {item.label}
                    </div>
                    <p className="text-[9px] text-gray-600 font-mono leading-tight uppercase opacity-60 group-hover:opacity-100 transition-opacity">
                      {item.desc}
                    </p>
                  </motion.div>
                ))}
          ...
          <div className="flex flex-col justify-center h-full space-y-12 overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <span
                  className={`text-[9px] font-mono ${slide.color} font-black uppercase tracking-[0.4em] animate-pulse`}
                >
                ...
                <p className="text-base text-gray-400 font-light leading-relaxed border-l border-white/10 pl-6 italic">
                  {slide.content}
                </p>
                <Button
              ...
              <div className="bg-[#050505] border border-white/10 p-8 h-[280px] lg:h-[320px] relative group overflow-hidden shadow-inner">
                ...
                <div className="absolute top-4 left-8 text-[7px] font-mono text-gray-700 uppercase font-black tracking-[0.4em]">
                  Inference_Load // S1_Kernel
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="flex justify-between items-center mb-6 px-6 flex-shrink-0">
        <div className="flex items-center gap-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-lg font-black text-white uppercase tracking-[0.2em] leading-none">
                Series_A_Investment
              </h2>
              <span className="text-[8px] font-mono text-gray-700 uppercase mt-1.5 block tracking-widest font-black">
                PolyGuard // Confidential // v4.2
              </span>
            </div>
          </div>
            ...
            {SECTIONS.map((sec, i) => {
              ...
              return (
                <div key={i} className="flex items-center gap-2">
                  <div
                    className={`w-1.5 h-1.5 rounded-none rotate-45 transition-all duration-500 ${isCurrent ? 'bg-polygon-purple scale-125 shadow-[0_0_8px_#7b3fe4]' : isPast ? 'bg-gray-700' : 'bg-gray-900'}`}
                  ></div>
                  <span
                    className={`text-[8px] font-mono font-black uppercase tracking-widest transition-colors duration-500 ${isCurrent ? 'text-white' : 'text-gray-800'}`}
                  >
                    {sec}
                  </span>
                </div>
        ...
        <div className="flex items-center gap-6">
          <div className="flex flex-col items-end">
            <span className="text-[8px] font-mono text-gray-700 uppercase font-black tracking-widest">
              Sequence_Step
            </span>
            <span className="text-base font-mono text-white font-black">
              {currentSlide + 1} <span className="text-gray-800">/ {SLIDES.length}</span>
            </span>
          </div>
        ...
        <div className="absolute bottom-6 left-10 right-10 flex justify-between items-center text-[7px] font-mono text-gray-800 uppercase tracking-[0.5em] pointer-events-none font-black">
          <div className="flex items-center gap-6">
            <span className="flex items-center gap-2">
              <div className="w-1 h-1 bg-polygon-purple animate-pulse shadow-[0_0_5px_#7b3fe4]"></div>{' '}
              UPLINK_SECURE
            </span>
            <span className="opacity-30">
              HEX_SIG: {Math.random().toString(36).substr(2, 12).toUpperCase()}
            </span>
          </div>
          <span className="text-polygon-purple/10">© POLYGUARD_SYSTEMS_2026</span>
        </div>
        ...
        {SLIDES.map((s, i) => (
          <button
            ...
            className={`group relative flex-shrink-0 w-12 lg:w-14 h-1 transition-all duration-500 ${
              i === currentSlide
                ? 'bg-polygon-purple lg:w-20 shadow-[0_0_10px_#7b3fe4]'
                : i < currentSlide
                  ? 'bg-gray-700'
