...
const SLIDES: SlideData[] = [
    {
        ...
        content: "PolyGuard is the first autonomous security kernel engineered to protect $150B+ in cross-chain liquidity across the fully decentralized Polygon AggLayer ecosystem.",
    ...
    },
    {
        ...
        layout: "comparison",
        comparison: [
            { metric: "Detection Latency", polyguard: "350ms (Real-time)", traditional: "14 Days (Manual)" },
            { metric: "Analysis Depth", polyguard: "Heuristic Opcode", traditional: "Pattern Static" },
            { metric: "AggLayer Support", polyguard: "Native Cluster", traditional: "None / Bridge-only" },
    ...
    },
    {
        ...
        content: "Seeking strategic partners to scale our heuristic node network and establish PolyGuard as the default security module for institutional chains.",
        icon: StarIcon,
        color: "text-white",
        layout: "hero"
    }
                                ...
                                <table className="w-full text-left font-mono border-collapse min-w-[600px]">
                                    <thead>
                                        <tr className="border-b border-white/10 bg-white/[0.03]">
                                            ...
                                            <th className="p-5 text-[9px] text-polygon-purple-light uppercase tracking-widest text-center bg-polygon-purple/5 font-black border-l border-white/10">PolyGuard_v4</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                ...
                <div className="flex items-center gap-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <span className="text-[8px] font-mono text-gray-700 uppercase mt-1.5 block tracking-widest font-black">PolyGuard // Confidential // v4.2</span>
                        </div>
                    </div>
