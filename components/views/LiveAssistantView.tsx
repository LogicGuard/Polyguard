        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 font-mono">
              Real-Time Voice-to-Security Intelligence
            </p>
          </div>
        </div>
        {isActive && (
          <div className="flex items-center gap-4 bg-black/40 border border-white/5 px-4 py-2 rounded-sm">
            <div className="flex flex-col items-end">
              <span className="text-[8px] text-gray-600 font-mono uppercase font-bold tracking-widest">
                Connection_Strength
              </span>
              <div className="flex gap-0.5 mt-1">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className={`w-1 h-2 rounded-sm ${i <= 3 ? 'bg-blue-500' : 'bg-gray-800'}`}
                  ></div>
                ))}
              </div>
            </div>
        ...
        <div className="lg:col-span-7 flex flex-col gap-6 h-full">
          <Card className="flex-1 flex flex-col items-center justify-center p-8 bg-[#050505] relative overflow-hidden group">
            ...
            <div className="absolute top-4 left-4 flex flex-col gap-1">
              <div className="text-[8px] font-mono text-gray-600 uppercase font-bold tracking-widest">
                Biometric_Kernel
              </div>
              <div className="text-[10px] text-blue-400 font-mono">POLYGUARD_S1</div>
            </div>
                ...
                {permissionError ? (
                  ...
                  >
                    ...
                    <p className="text-[10px] font-mono text-gray-500 uppercase leading-relaxed">
                      Please enable microphone permissions in your browser settings to utilize the
                      Live Specialist uplink.
                    </p>
                    <Button
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="relative z-10 p-8 rounded-full bg-white/5 border border-white/10 backdrop-blur-md shadow-2xl">
                        <CpuIcon
                          className={`w-12 h-12 ${audioLevel > 20 ? 'text-blue-400' : 'text-gray-600'} transition-colors duration-200`}
                        />
                      </div>
                    </div>
                  </motion.div>
            ...
            <div className="mt-12 flex flex-col items-center">
              ...
              <p className="mt-4 text-[9px] font-mono text-gray-600 uppercase tracking-widest">
                {isActive
                  ? 'Listening_For_Instructions...'
                  : permissionError
                    ? 'Awaiting_System_Fix'
                    : 'Awaiting_Voice_Handshake'}
              </p>
            </div>
          </Card>
          ...
          <Card className="h-32 bg-[#080808] border-white/10 p-4 relative overflow-hidden flex flex-col">
            <div className="absolute top-2 right-4 text-[8px] font-mono text-gray-700 uppercase tracking-tighter">
              Live_Transcription
            </div>
            <div className="flex-1 overflow-y-auto custom-scrollbar pt-2 pr-2">
              ...
              {!currentInput && !currentOutput && !isActive && (
                <div className="text-xs font-mono text-gray-700 uppercase text-center mt-6">
                  Buffer_Empty
                </div>
              )}
            </div>
        ...
        <div className="lg:col-span-5 flex flex-col h-full overflow-hidden">
          <Card className="flex-1 flex flex-col bg-[#030303] border-white/10 p-0 overflow-hidden shadow-2xl">
            ...
            <div className="p-2 border-t border-white/5 bg-black/40 text-center">
              <span className="text-[8px] font-mono text-gray-700 uppercase tracking-tighter">
                End_Of_History_Buffer
              </span>
            </div>
          </Card>
        </div>
