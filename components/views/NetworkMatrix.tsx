    ...
    >
      ...
      <motion.g className="opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <text
          ...
          fill="white"
          fontSize="5.5"
          className="font-mono uppercase font-black tracking-widest"
        >
          {label}
        </text>
      </motion.g>
          ...
          >
            ...
            <div className="flex justify-between items-center pt-3 border-t border-white/10">
              <span className="text-[8px] font-mono text-gray-500 uppercase">
                ZK Batch Settlement: OPTIMAL
              </span>
              <button
                onClick={() => {
                  alert(
                    `Triggering live RPC ping to ${selectedNodeDetails.label}... Connection verified.`
                  );
