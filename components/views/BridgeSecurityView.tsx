...
const BridgeSecurityView: React.FC = () => {
  ...
  const [bridgeLang, setBridgeLang] = useState<'RUST_SP1' | 'GO_CLIENT' | 'SOL_YUL' | 'PLONKY2'>(
    'RUST_SP1'
  );
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-8">
        <div className="lg:col-span-4">
          <Card className="p-6 bg-[#080808] border-white/10 h-full flex flex-col">
            <label className="text-[10px] font-bold text-gray-500 uppercase font-mono mb-4 block">
              Bridge Protocol Entry
            </label>
            <Input
            ...
            <div className="space-y-4 flex-1">
              <p className="text-[10px] text-gray-600 font-mono leading-relaxed uppercase">
                Analysis targets withdrawal safety, mint/burn logic, and multi-sig threshold
                verification.
              </p>
            </div>
            <Button
              ...
              disabled={isLoading}
              className="w-full justify-center py-4 mt-8"
            >
            ...
            {isLoading ? (
              <Card className="h-full flex items-center justify-center p-12 bg-black border-white/5">
                <div className="text-center">
                  ...
                  <p className="text-[10px] font-mono text-gray-500 uppercase tracking-[0.4em] animate-pulse">
                    Scanning_Cross_Chain_Vectors...
                  </p>
                </div>
              </Card>
            ) : result ? (
              ...
              >
                <Card className="p-6 flex flex-col items-center justify-center text-center bg-[#0C0C0C]">
                  <div className="text-[9px] font-mono text-gray-500 uppercase tracking-widest mb-6">
                    Security_Confidence
                  </div>
                  <div className="relative w-32 h-32 flex items-center justify-center">
                    <svg className="absolute inset-0 w-full h-full -rotate-90">
                      ...
                      <motion.circle
                        ...
                        animate={{
                          strokeDashoffset: 377 - (377 * result.securityScore.score) / 100,
                        }}
                  ...
                  <p className="text-xs font-mono mt-6 text-gray-400">
                    {result.securityScore.summary}
                  </p>
                </Card>
                ...
                <div className="space-y-4">
                  <Card className="p-5 border-green-500/20 bg-green-500/5">
                    ...
                    <div className="text-xl font-mono text-green-400 font-black mb-1">
                      {result.liquidityRisk.risk.toUpperCase()}_RISK
                    </div>
                    <p className="text-[10px] text-gray-500 font-mono leading-tight">
                      {result.liquidityRisk.summary}
                    </p>
                  </Card>
                  <Card className="p-5 border-yellow-500/20 bg-yellow-500/5">
                    ...
                    <div className="text-xl font-mono text-yellow-400 font-black mb-1">
                      {result.withdrawalSafety.risk.toUpperCase()}_RISK
                    </div>
                    <p className="text-[10px] text-gray-500 font-mono leading-tight">
                      {result.withdrawalSafety.summary}
                    </p>
                  </Card>
                </div>
              </motion.div>
