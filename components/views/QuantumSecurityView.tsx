  ...
  return (
    <div>
      ...
      <p className="text-brand-text-light mb-6">
        Analyze a contract's resilience against future quantum computing threats.
      </p>
      ...
      {result && (
        <div className="space-y-6">
          <Card className="p-6">
            ...
            <div
              className={`p-4 rounded-lg mb-4 ${result.readinessStatus === 'Quantum-Resistant' ? 'bg-green-500/10 text-green-300' : 'bg-red-500/10 text-red-300'}`}
            >
