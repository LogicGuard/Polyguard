      ...
      <div className="h-full flex flex-col p-4 bg-[#050505] relative overflow-hidden">
        ...
        <div className="flex justify-between items-start mb-4 border-b border-white/5 pb-3 relative z-10">
          ...
          <button
            ...
            disabled={isLoading}
            className="p-1.5 hover:bg-white/5 border border-white/5 rounded-sm transition-all group disabled:opacity-30"
          >
            <RefreshIcon
              className={`w-3.5 h-3.5 text-gray-500 group-hover:text-blue-400 ${isLoading ? 'animate-spin' : ''}`}
            />
          </button>
        </div>
                    ...
                    chunk.web && (
                      ...
                      >
                        <div className="flex items-center gap-2 min-w-0">
                          ...
                          <span className="truncate text-gray-400 group-hover:text-white transition-colors uppercase font-bold">
                            {chunk.web.title}
                          </span>
                        </div>
                        <span className="text-[8px] text-gray-600 font-black group-hover:text-blue-400 transition-colors">
                          LINK_EXT
                        </span>
                      </a>
                    )
