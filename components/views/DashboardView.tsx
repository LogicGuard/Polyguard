    ...
    <div className="relative h-full w-full bg-[#020202] overflow-y-auto lg:overflow-hidden flex flex-col p-3 md:p-4 gap-3 md:gap-4 select-none custom-scrollbar">
      ...
      >
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-between gap-2 px-3 py-2 bg-[#080808] border border-white/5 flex-shrink-0"
        >
          ...
          <div className="flex items-center gap-4 text-[8.5px] font-mono">
            <span className="text-gray-500 hidden sm:inline">
              SWARM_AGENTS: <span className="text-emerald-400 font-bold">8/8 ONLINE</span>
            </span>
            <span className="text-gray-500 hidden md:inline">
              ACCOUNT:{' '}
              <span className="text-white font-bold">
                {account ? `${account.substring(0, 6)}...${account.substring(38)}` : '0x71C...49A2'}
              </span>
            </span>
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-3 md:gap-4 min-h-0 overflow-hidden">
          ...
          <div className="lg:col-span-8 flex flex-col gap-3 md:gap-4 min-h-0 overflow-hidden">
            <div className="flex-[3] grid grid-cols-1 md:grid-cols-12 gap-3 md:gap-4 min-h-0">
              <motion.div
                variants={itemVariants}
                className="md:col-span-8 min-h-[260px] md:min-h-0 h-full"
              >
                <NetworkMatrix />
              </motion.div>
              <motion.div
                variants={itemVariants}
                className="md:col-span-4 min-h-[220px] md:min-h-0 h-full"
              >
                <ActivityHeatmap />
              </motion.div>
            </div>
            ...
            <div className="flex-[2] grid grid-cols-1 md:grid-cols-12 gap-3 md:gap-4 min-h-0">
              <motion.div
                variants={itemVariants}
                className="md:col-span-7 min-h-[200px] md:min-h-0 h-full"
              >
                <HeuristicMatrix />
              </motion.div>
              <motion.div
                variants={itemVariants}
                className="md:col-span-5 min-h-[220px] md:min-h-0 h-full"
              >
          ...
          <div className="lg:col-span-4 flex flex-col gap-3 md:gap-4 min-h-0 overflow-hidden">
            <motion.div
              variants={itemVariants}
              className="flex-[3] min-h-[320px] lg:min-h-0 h-full"
            >
              <RealTimeMonitor />
            </motion.div>
            <motion.div
              variants={itemVariants}
              className="flex-[1] min-h-[160px] lg:min-h-0 h-full"
            >
              <SystemVitalsStrip />
            </motion.div>
          </div>
