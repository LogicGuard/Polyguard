...
const PortfolioView: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      {error && (
        <Card className="mb-6 p-4 bg-red-500/10 border-red-500/30 text-red-400 font-mono text-sm">
          {error}
        </Card>
      )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            <Card className="p-6 flex flex-col items-center bg-[#080808]">
              <h3 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-6 w-full text-left">
                Allocation Matrix
              </h3>
