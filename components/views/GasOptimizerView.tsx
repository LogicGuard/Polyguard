      ...
      properties: {
        speeds: {
          ...
          items: {
            ...
            required: ['name', 'gwei', 'time', 'savings'],
          },
        },
        recommendation: {
          type: 'OBJECT',
          ...
          required: ['type', 'summary', 'maxFeePerGas', 'maxPriorityFeePerGas'],
        },
        ...
        <div className="md:col-span-1 space-y-4">
          <Card className="p-4 bg-[#080808]">
            <div className="flex justify-between items-center mb-2">
              <label className="text-[10px] font-bold text-gray-500 uppercase font-mono">
                Transaction Payload
              </label>
              <span className="text-[10px] text-blue-400 font-mono cursor-pointer hover:text-white">
                Load Last Tx
              </span>
            </div>
            <Textarea
          ...
          {isLoading ? (
            <Card className="h-full flex items-center justify-center p-12">
              <div className="flex flex-col items-center">
                <ViewLoader />
                <p className="mt-4 text-xs font-mono text-gray-500 animate-pulse">
                  Querying Mempool Aggregators...
                </p>
              </div>
            </Card>
          ) : !result ? (
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4 h-64">
                {result.speeds.map((speed: any, i: number) => (
                  <Card
                    key={i}
                    className="relative overflow-hidden flex flex-col justify-end p-4 border-white/10 hover:border-white/30 transition-colors group"
                  >
                    ...
                    <div className="relative z-10 text-center">
                      ...
                      {speed.savings !== '0%' && (
                        <div
                          className={`text-[10px] font-bold mt-2 px-2 py-0.5 rounded-full inline-block ${speed.savings.includes('-') ? 'bg-red-500/20 text-red-400' : 'bg-green-500/20 text-green-400'}`}
                        >
              ...
              <Card className="p-6 bg-[#080808]">
                <h3 className="text-sm font-bold text-white uppercase tracking-widest mb-4 border-b border-white/10 pb-2">
                  Analysis Report
                </h3>
