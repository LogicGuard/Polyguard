...
const ArchitectureDiagram: React.FC<{ onNavigate: (id: string) => void }> = ({ onNavigate }) => {
  const nodes = [
    ...
    {
      id: 'kernel',
      label: 'Heuristic_Kernel',
      x: 300,
      y: 150,
      icon: CpuIcon,
      target: 'heuristic-kernel',
    },
    ...
    <div className="my-12 p-8 bg-[#050505] border border-white/10 rounded-sm relative overflow-hidden group/diag shadow-2xl">
      ...
      <div className="flex justify-between items-center mb-10 relative z-10">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] font-mono text-gray-400 font-black uppercase tracking-[0.3em]">
            Interactive_System_Schematic
          </span>
        </div>
      </div>
        ...
        {nodes.map((node) => (
          ...
          >
            <circle
              ...
              strokeWidth="1"
              className="group-hover/node:stroke-blue-500/50 transition-colors"
            />
            ...
            <text
              ...
              textAnchor="middle"
              fill="#555"
              className="text-[9px] font-mono font-black uppercase tracking-widest group-hover/node:fill-white transition-colors"
            >
              {node.label}
            </text>
          </motion.g>
            ...
            {spheres.map((sphere) => {
              ...
              return (
                <div key={sphere} className="space-y-1">
                  <span className="px-3 mb-2 block text-[8px] font-black text-gray-600 uppercase tracking-[0.3em] font-mono">
                    {sphere.replace('_', ' ')}
                  </span>
                  {sphereDocs.map((doc) => (
                    <button
                    ...
                    >
                      {activeId === doc.id && (
                        <motion.div
                          ...
                          className="absolute left-0 top-0 bottom-0 w-[2px] bg-blue-500 shadow-[0_0_10px_rgba(59,130,246,0.5)]"
                        />
                      )}
                      <doc.icon
                        className={`w-3.5 h-3.5 flex-shrink-0 ${activeId === doc.id ? 'text-blue-400' : 'opacity-40 group-hover:opacity-100'}`}
                      />
                      <span className="text-[10px] font-bold uppercase tracking-wide truncate font-mono flex-1">
                        {doc.title}
                      </span>
                    </button>
                  ))}
      ...
      <main className="flex-1 flex flex-col min-w-0 h-full relative">
        <Card className="flex-1 p-0 overflow-hidden bg-[#030303] border-white/10 flex flex-col relative rounded-none">
          ...
          <div className="h-14 border-b border-white/5 flex items-center justify-between px-6 bg-[#080808]/90 backdrop-blur-xl z-20 flex-shrink-0">
            ...
            <div className="flex items-center gap-3">
              <span className="text-[8px] font-mono text-gray-600 uppercase hidden sm:block">
                Ver_{activeDoc.version}
              </span>
              <div
              ...
              >
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 border-b border-white/5 pb-10 gap-8">
                  ...
                  <div className="text-left md:text-right font-mono">
                    <div className="text-[8px] text-gray-600 uppercase font-black tracking-widest">
                      Lead_Architect
                    </div>
                    <div className="text-[10px] text-blue-400/80 mt-1 uppercase font-bold">
                      {activeDoc.author}
                    </div>
                    <div className="mt-4 flex gap-2 md:justify-end text-[8px] font-mono text-gray-500">
                      <span className="px-2 py-1 bg-white/5 border border-white/10 rounded-sm">
                        LANG: EN_US
                      </span>
                      <span className="px-2 py-1 bg-white/5 border border-white/10 rounded-sm">
                        SIG: AUTH_S1
                ...
                {/* Main Article Body */}
                <div className="flex-1">{renderDocContent(activeDoc.content)}</div>
                ...
                <div className="mt-20 pt-10 border-t border-white/5 grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-[11px] font-black text-white uppercase mb-1 tracking-widest">
                          Core_Integration
                        </h4>
                        <p className="text-[9px] text-gray-500 font-mono uppercase leading-relaxed">
                          Deploy SDK buffer and primitives.
                        </p>
                      </div>
                    </div>
                  </Card>
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[9px] text-gray-500 font-mono uppercase leading-relaxed">
                          Configure firewall logic gates.
                        </p>
                      </div>
                    </div>
                  </Card>
