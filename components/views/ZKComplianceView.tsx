...
const RUST_HALO2_CIRCUIT = `// PolyGuard Rust Halo2 Plonkish Regulatory Compliance Verifier
use halo2_proofs::{
    arithmetic::Field,
...
const CIRCOM_2_CIRCUIT = `// PolyGuard Regulatory Solvency & AML Sanction Inclusion Circuit
