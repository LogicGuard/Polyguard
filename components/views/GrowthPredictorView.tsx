    ...
    <div className="max-w-6xl mx-auto h-[calc(100vh-140px)] flex flex-col">
      <div className="flex items-center justify-between mb-8 flex-shrink-0">
        ...
        <Button
          ...
          disabled={isLoading}
          className="!px-10 py-3 bg-white text-black hover:bg-gray-200"
        >
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 min-h-0">
        <div className="lg:col-span-1 space-y-6 overflow-y-auto custom-scrollbar pr-2">
          <Card className="p-6 bg-[#080808] border-white/10 relative overflow-hidden">
            ...
            <div className="text-[10px] font-mono text-gray-600 uppercase tracking-widest font-black mb-6">
              Market_Sentiment
            </div>
          ...
          <Card className="p-6 bg-[#080808] border-white/10">
            <h3 className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-4 font-mono">
            ...
            <div className="space-y-3">
              {[
                ...
                >
                  ...
                  <span
                    className={`text-[10px] font-mono font-black ${item.s === 'up' ? 'text-green-400' : 'text-blue-400'}`}
                  >
                    {item.v}
                  </span>
                </div>
          ...
          <AnimatePresence mode="wait">
            {isLoading ? (
              ...
              <div className="h-full flex flex-col items-center justify-center border border-white/5 border-dashed bg-white/[0.01] rounded-sm p-12 text-center">
                ...
                <h4 className="text-xs font-mono uppercase tracking-[0.3em] text-gray-600">
                  Forecaster_Idle
                </h4>
                <p className="text-[10px] font-mono text-gray-700 mt-2 uppercase">
                  Initialize the prediction engine to view projected network expansion metrics.
                </p>
              </div>
            )}
          </AnimatePresence>
