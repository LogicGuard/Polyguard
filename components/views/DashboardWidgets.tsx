...
export const DashboardMetricCard: React.FC<MetricCardProps> = ({
  ...
  glow,
  trend = '+2.4%',
  sparklineData = [30, 45, 35, 60, 50, 75, 90],
  onClick,
}) => {
      ...
      <div className="relative z-10 flex flex-col justify-between h-full space-y-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[8.5px] font-mono text-gray-500 uppercase tracking-[0.2em] font-black">
              {label}
            </span>
          </div>
        ...
        <div className="flex items-baseline justify-between gap-2 pt-1">
          <div
            className={`text-2xl font-black text-white tracking-tighter font-mono group-hover:text-blue-400 transition-colors`}
          >
            {value}
          </div>
        ...
        <div className="flex items-center gap-2 pt-1 border-t border-white/5">
          ...
          ></div>
          <span className="text-[7.5px] font-mono text-gray-500 uppercase font-black tracking-widest">
            {sub}
          </span>
        </div>
      </div>
...
export const SystemVitalsStrip: React.FC = () => (
  <Card className="h-full bg-[#080808] p-0 border-white/5 overflow-hidden flex flex-col shadow-xl rounded-none relative">
    <div className="p-3 border-b border-white/5 bg-black/60 flex justify-between items-center">
      <span className="text-[8px] font-mono text-gray-400 uppercase font-black tracking-widest">
        Platform_Vitals
      </span>
      <span className="text-[8px] font-mono text-emerald-400 font-black uppercase">
        99.98% Healthy
      </span>
    </div>
    ...
    <div className="p-2 bg-black/80 text-center border-t border-white/5 flex justify-between items-center px-3">
      <span className="text-[7.5px] font-mono text-blue-500 uppercase font-black tracking-[0.2em]">
        Swarm: 8/8 Online
      </span>
