...
const ContractAnalysisView: React.FC = () => {
  ...
  const [deploymentInfo, setDeploymentInfo] = useState<{ block: string; timestamp: string } | null>(
    null
  );
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 font-mono">
            Bytecode Heuristics // Vulnerability Mapping
          </p>
        </div>
      </div>
        ...
        <div className="lg:col-span-5 space-y-4">
          <Card className="p-0 bg-[#080808] border-white/10 overflow-hidden">
            <div className="p-3 border-b border-white/10 bg-[#0A0A0A] flex justify-between items-center">
              ...
              <ActivityIcon
                className={`w-3 h-3 ${isLoading ? 'text-blue-500 animate-pulse' : 'text-gray-700'}`}
              />
            </div>

            <div className="p-6 space-y-6">
              <div className="relative">
                <label className="block text-[10px] font-bold text-gray-500 mb-2 uppercase font-mono">
                  Contract Identity (Hex)
                </label>
                <div className="relative group">
                  ...
                  <div className="absolute right-3 top-1/2 -translate-y-1/2 flex gap-1">
                    <div
                      className={`w-1.5 h-1.5 rounded-full ${validation.hexPrefix ? 'bg-blue-500' : 'bg-white/5'}`}
                    ></div>
                    <div
                      className={`w-1.5 h-1.5 rounded-full ${validation.length ? 'bg-blue-500' : 'bg-white/5'}`}
                    ></div>
                  </div>
                </div>
              </div>
                  ...
                  >
                    <div className="p-4 bg-blue-500/5 border border-blue-500/10 rounded-sm space-y-3">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h4 className="text-[9px] font-mono text-blue-400 uppercase tracking-widest font-black">
                          Deployment_Origin
                        </h4>
                      </div>
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <span className="text-[8px] font-mono text-gray-600 uppercase block mb-1">
                            Block_Height
                          </span>
                          <a
                          ...
                          >
                            ...
                            <span className="text-[8px] opacity-0 group-hover/link:opacity-100 transition-opacity">
                              ↗
                            </span>
                          </a>
                        </div>
              ...
              <div className="space-y-2 bg-black/40 p-3 border border-white/5 rounded-sm">
                <h4 className="text-[9px] font-mono text-gray-600 uppercase tracking-widest mb-2">
                ...
                <div className="grid grid-cols-1 gap-1.5">
                  {[
                    ...
                    <div key={idx} className="flex items-center justify-between">
                      <span
                        className={`text-[10px] font-mono ${check.valid ? 'text-gray-400' : 'text-gray-600'}`}
                      >
                        {check.label}
                      </span>
                      {check.valid ? (
          ...
          {error && (
            ...
            >
              ...
              <p className="text-[10px] font-mono text-red-400 uppercase tracking-tight leading-relaxed">
                {error}
              </p>
            </motion.div>
          )}
          ...
          <div className="grid grid-cols-2 gap-3">
            <Card
              className="p-3 bg-white/[0.02] border-white/5 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-white/[0.05]"
            ...
            <Card
              className="p-3 bg-white/[0.02] border-white/5 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-white/[0.05]"
              onClick={() => setAddress('0x0000000000000000000000000000000000001010')}
            >
              ...
              >
                <Card className="h-full flex flex-col items-center justify-center p-12 bg-[#050505] relative overflow-hidden">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <h3 className="text-sm font-mono font-bold text-white uppercase tracking-[0.3em] mb-2">
                      Analyzing_Bytecode
                    </h3>
                    <p className="text-[10px] font-mono text-gray-500 uppercase">
                      Checking reentrancy guards, ownership logic, and gas vectors...
                    </p>
              ...
              >
                <div className="h-full flex flex-col items-center justify-center border border-white/10 border-dashed bg-white/[0.02] p-12 text-center rounded-sm">
                  ...
                  <p className="text-[10px] font-mono text-gray-600 max-w-xs uppercase leading-relaxed">
                    Input a verified contract address to generate a cryptographic security
                    assessment.
                  </p>
                </div>
              </motion.div>
