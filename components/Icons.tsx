...
export const AuditorIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    {' '}
...
export const TransactionIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    {' '}
    <path d="M17 22h-1a2 2 0 0 1-2-2v-4a2 2 0 0 1 2-2h1"></path>{' '}
    <path d="M7 2h1a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2H7"></path> <path d="M14 16h-4"></path>{' '}
    <path d="M10 8h4"></path> <path d="M7 16h.01"></path> <path d="M17 8h-.01"></path>{' '}
  </IconWrapper>
);
...
export const WalletIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    {' '}
    <path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"></path> <path d="M3 5v14a2 2 0 0 0 2 2h16v-5"></path>{' '}
...
export const NFTIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    {' '}
    <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect> <path d="M8 12h8"></path>{' '}
    <path d="M12 8v8"></path>{' '}
  </IconWrapper>
);
export const BridgeIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    {' '}
    <path d="M8 18h8"></path> <path d="M6 12h12"></path> <path d="M4 6h16"></path>{' '}
    <path d="M2 12h2"></path> <path d="M20 12h2"></path>{' '}
  </IconWrapper>
);
export const StakingIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    {' '}
    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>{' '}
...
export const QuantumIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    {' '}
    <circle cx="12" cy="12" r="2"></circle> <path d="M12 2v4"></path> <path d="M12 18v4"></path>{' '}
    <path d="m4.93 4.93 2.83 2.83"></path> <path d="m16.24 16.24 2.83 2.83"></path>{' '}
    <path d="M2 12h4"></path> <path d="M18 12h4"></path> <path d="m4.93 19.07 2.83-2.83"></path>{' '}
    <path d="m16.24 7.76 2.83-2.83"></path>{' '}
  </IconWrapper>
);
export const ZKIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    {' '}
    <path d="M10 21H8a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v1.5"></path>{' '}
    <path d="M10 12h4"></path> <path d="M10 16h4"></path> <path d="M10 8h2"></path>{' '}
    <path d="M17 18a2 2 0 0 0 2-2v-1a2 2 0 0 0-2-2h-1a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2v1a2 2 0 0 0 2 2h-1a2 2 0 0 0-2-2v-1"></path>{' '}
  </IconWrapper>
);
export const ComplianceIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    {' '}
    <path d="m12 16 4-4-4-4"></path> <path d="M8 12H4"></path> <path d="M20 12h-8"></path>{' '}
  </IconWrapper>
);
export const OnChainIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    {' '}
...
export const EcosystemIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    {' '}
...
export const ThreatIntelIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    {' '}
...
export const GasIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    {' '}
    <path d="M14 3h7v7"></path> <path d="M3 21h7v-7"></path> <path d="M21 3l-7.5 7.5"></path>{' '}
...
export const DAOIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    {' '}
...
export const DAppIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    {' '}
    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path> <path d="M12 7v10"></path>{' '}
...
export const LightbulbIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    <path d="M9 18h6" />
    <path d="M10 22h4" />
    <path d="M12 2a7 7 0 0 0-4.95 11.95A7 7 0 0 0 12 22a7 7 0 0 0 4.95-8.05A7 7 0 0 0 12 2z" />
  </IconWrapper>
);
...
export const UserBehaviorIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    <path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
    <circle cx="8.5" cy="7" r="4" />
    <path d="M18 8a4 4 0 0 1 4 4v2" />
    <path d="M22 18a4 4 0 0 1-4-4v-2" />
  </IconWrapper>
);
...
export const HelpCircleIcon: React.FC<IconProps> = (props) => (
  <IconWrapper {...props}>
    ...
    <circle
      ...
      cy="12"
      r="10"
    ></circle> <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path>{' '}
    <line x1="12" y1="17" x2="12.01" y2="17"></line>{' '}
  </IconWrapper>
);
