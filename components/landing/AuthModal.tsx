          ...
          <Card className="p-0 bg-[#0C0C0C] border border-white/10 relative overflow-hidden shadow-2xl">
            ...
            <div className="p-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-[10px] font-bold text-gray-500 mb-1.5 uppercase font-mono">
                    User Identifier
                  </label>
                  <Input
                    type="email"
                ...
                <Button
                  type="submit"
                  className="w-full py-3 mt-2 rounded-sm text-xs font-bold uppercase bg-white text-black hover:bg-gray-200 border-none"
                  disabled={isLoading}
                >
              ...
              <div className="relative my-6 text-center">
                <span className="bg-[#0C0C0C] px-2 text-[10px] text-gray-600 font-mono uppercase relative z-10">
                  Alternative Auth
                </span>
              ...
              <Button
                variant="secondary"
                className="w-full py-2.5 rounded-sm text-xs font-bold uppercase border-white/10 hover:bg-white/5 bg-transparent"
                onClick={onSuccess}
                Icon={WalletIcon}
              >
                Wallet Signature
