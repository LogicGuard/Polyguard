      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
        <div className="lg:col-span-5 space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-polygon-purple/10 border border-polygon-purple/20 rounded-sm">
            ...
            <span className="text-[10px] font-mono text-polygon-purple-light uppercase tracking-[0.2em] font-black">
              Kernel_Preview
            </span>
          </div>
          <h2 className="text-3xl md:text-5xl font-black text-white tracking-tighter uppercase leading-[0.9]">
            Autonomous <br />
            <span className="text-polygon-purple">Surveillance</span>
          </h2>
          <p className="text-gray-500 leading-relaxed text-sm font-light max-w-md">
            Execute the <span className="text-white font-medium">Gemini Pro security kernel</span>{' '}
            on-demand. Deploy tactical static analysis to identify exploit signatures.
          </p>
        ...
        <div className="lg:col-span-7">
          <Card className="p-0 bg-[#080808] border-white/10 overflow-hidden shadow-2xl relative rounded-none">
            ...
            <div className="p-4 border-t border-white/5 bg-[#0A0A0A] flex justify-between items-center">
              <div className="text-[8px] font-mono text-gray-600 uppercase font-black tracking-widest">
                Awaiting_Handshake
              </div>
              <Button
                onClick={handleScan}
                  ...
                  <div className="p-6">
                    <div className="flex justify-between items-center mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-[9px] font-mono text-green-500 uppercase font-black tracking-widest">
                          Heuristic_Output
                        </span>
                      </div>
                      <button
                        onClick={() => setResult(null)}
                        className="text-[8px] text-gray-600 hover:text-white uppercase font-mono font-black tracking-widest"
                      >
                        Purge
                      </button>
                    </div>
