...
const FAQS = [
    ...
    },
    {
        ...
        answer: "Negative. PolyGuard operates as a non-custodial intelligence layer. We analyze public on-chain state and user-provided bytecode. Seed phrases and private keys are never requested or stored."
    },
    {
        id: "KB_003",
