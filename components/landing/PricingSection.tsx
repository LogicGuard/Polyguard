      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20 space-y-4">
          <div className="inline-block px-3 py-1 bg-polygon-purple/10 border border-polygon-purple/20 rounded-full mb-2">
            <span className="text-[9px] font-mono text-polygon-purple-light uppercase tracking-[0.3em] font-bold">
              Allocation
            </span>
          </div>
          <h2 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tighter">
            Security <span className="text-polygon-purple">Authorization</span>
          </h2>
              ...
              <div className="p-8 flex-1 relative z-10">
                <div className="mb-10">
                  <div className="flex justify-between items-start mb-6">
                    <h3 className="text-[9px] font-mono text-gray-500 uppercase tracking-[0.3em] font-black">
                      {tier.name}
                    </h3>
                    {tier.popular && (
                  ...
                  <ul className="space-y-3">
                    {tier.features.map((feature, i) => (
                      <li key={i} className="flex items-start gap-3 group/item">
                        ...
                        <span className="font-mono text-[10px] text-gray-400 group-hover/item:text-gray-200 transition-colors uppercase tracking-tight">
                          {feature}
                        </span>
                      </li>
                    ))}
