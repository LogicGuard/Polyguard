...
const STEPS = [
  {
    ...
    description:
      'Securely link wallet signatures. The system immediately aggregates on-chain history, token approvals, and AggLayer logs into a local context buffer.',
    icon: WalletIcon,
  ...
  },
  {
    ...
    description:
      'Data is piped through our fine-tuned LLM kernel. Millions of exploit vectors are cross-referenced against your specific Polygon node interactions.',
    icon: SearchIcon,
    status: 'PROCESSING',
  },
  {
    ...
    description:
      'Receive a prioritized threat matrix. Auto-generate revocation transactions and deploy firewall rules to neutralize identified vulnerabilities.',
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 border-b border-white/5 pb-10">
          <div>
            ...
            <h2 className="text-4xl md:text-6xl font-black text-white mb-2 tracking-tighter uppercase">
              Standard <span className="text-polygon-purple">SOP</span>
            </h2>
          ...
          <div className="hidden md:block text-right">
            <div className="text-[10px] font-mono text-gray-600 uppercase tracking-widest font-black">
              POLYGON_S1_NODE_LOGIC
            </div>
            <div className="text-[10px] font-mono text-polygon-purple-light uppercase tracking-widest font-black">
              Sequence: 100% Linear
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="h-full bg-white/[0.01] border border-white/5 hover:border-polygon-purple/40 hover:bg-white/[0.03] transition-all duration-500 p-10 flex flex-col group relative overflow-hidden rounded-none">
                ...
                <div className="flex justify-between items-start mb-10">
                  <span className="text-5xl font-mono font-black text-white/[0.03] group-hover:text-polygon-purple/10 transition-colors leading-none tracking-tighter">
                    {step.id}
                  </span>
                ...
                <p className="text-[10px] font-mono text-polygon-purple-light mb-6 uppercase tracking-widest font-black">
                  {step.subtitle}
                </p>
