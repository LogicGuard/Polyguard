    ...
    >
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 h-full flex justify-between items-center">
        ...
        <div className="flex items-center gap-12">
          ...
          >
            <CyberpunkLogo
              className={`${scrolled ? 'scale-75' : 'scale-90'} transition-transform duration-500 origin-left`}
            />
          </div>
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            >
              <button className="flex items-center gap-2 text-[9px] font-black tracking-[0.2em] text-gray-400 hover:text-white transition-colors uppercase cursor-pointer group py-4">
                ...
                <ChevronDownIcon
                  className={`w-3 h-3 transition-transform duration-500 ${isMegaMenuOpen ? 'rotate-180 text-polygon-purple' : 'text-gray-600'}`}
                />
              </button>
                      ...
                      {PLATFORM_MODULES.map((module, i) => (
                        ...
                        >
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-[8px] font-mono text-gray-600 group-hover:text-polygon-purple-light transition-colors font-black uppercase tracking-widest">
                              {module.tag}
                            </span>
                          </div>
                          <h4 className="text-[12px] font-bold text-white uppercase tracking-wider mb-1">
                            {module.title}
                          </h4>
        ...
        <div className="flex items-center gap-6 xl:gap-8">
          ...
          <div className="hidden xl:flex flex-col items-end border-l border-white/10 pl-8 gap-1">
            <div className="flex items-center gap-2">
              <span className="text-[8px] font-mono text-gray-600 font-black uppercase tracking-widest leading-none">
                POLYGON_PULSE
              </span>
              <div className="w-1 h-1 bg-green-500 rounded-full animate-pulse"></div>
            </div>
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto custom-scrollbar p-8 space-y-12">
                <div className="space-y-6">
                  <div className="text-[9px] font-mono text-polygon-purple-light uppercase font-black tracking-[0.3em] mb-4">
                    Core_Systems
                  </div>
                  <button
                    onClick={() => handleModuleClick('documentation', 'pitch-deck')}
