        ...
        <div className="lg:col-span-7 flex flex-col justify-center text-center lg:text-left">
          ...
          >
            ...
            <p className="text-sm md:text-base text-gray-400 mb-10 max-w-xl mx-auto lg:mx-0 leading-relaxed font-light border-l-2 border-polygon-purple/50 pl-8 py-2">
              Deploying <span className="text-white font-medium">algorithmic auditing</span>,{' '}
              <span className="text-white font-medium">pre-execution shielding</span>, and{' '}
              <span className="text-white font-medium">tactical reconnaissance</span> to secure
            ...
            <div className="mt-12 lg:mt-20 grid grid-cols-3 max-w-md mx-auto lg:mx-0 gap-6 border-t border-white/10 pt-8">
              {[
                ...
                <div key={i} className="flex flex-col">
                  <span className="text-[8px] text-gray-500 font-mono uppercase tracking-[0.1em] mb-1 font-bold">
                    {stat.label}
                  </span>
                  <div className="flex items-baseline gap-1">
                    <span className="text-xl text-white font-mono font-bold tracking-tight">
                      {stat.val}
                    </span>
                  </div>
                  <span className="text-[7px] text-polygon-purple/80 font-mono font-bold tracking-widest">
                    {stat.sub}
                  </span>
                </div>
              ))}
          ...
          >
            ...
            <div className="relative z-10 group">
              <div className="absolute -top-4 -left-4 z-20 bg-polygon-purple/20 border border-polygon-purple/40 px-2 py-1 text-[8px] font-mono text-white uppercase tracking-widest hidden md:block backdrop-blur-md">
                <span className="animate-ping mr-2 inline-block w-1 h-1 bg-white rounded-full"></span>{' '}
                AGGLAYER_FEED
              </div>
