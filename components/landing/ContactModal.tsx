            ...
            {submitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 font-mono text-xs">
                  Uplink established. Standby for response.
                </p>
              </div>
            ) : (
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-4 border-t border-white/5">
                    <Button
                      ...
                      variant="secondary"
                      onClick={onClose}
                      className="flex-1 rounded-sm text-xs font-bold uppercase bg-transparent border border-white/10 hover:bg-white/5"
                    >
                      Abort
                    </Button>
                    <Button
                      type="submit"
                      disabled={isLoading}
                      className="flex-1 rounded-sm text-xs font-bold uppercase bg-white text-black hover:bg-gray-200 border-none"
                    >
