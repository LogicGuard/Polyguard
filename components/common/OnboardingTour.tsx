    ...
    <div className="fixed inset-0 z-[9999] overflow-hidden">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <p className="text-brand-text-light text-sm leading-relaxed mb-6">{step.description}</p>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              ...
              <Button onClick={handleNext} className="px-4 py-1.5 text-xs">
          ...
          <div
            className="absolute left-1/2 -translate-x-1/2 w-4 h-4 bg-[#0C0A1D] border-l border-t border-glass-border transform rotate-45 -z-10"
            style={
              step.position === 'top' || (!step.position && targetRect.top > 250)
                ? {
                    bottom: '-8px',
                    borderTop: 'none',
                    borderLeft: 'none',
