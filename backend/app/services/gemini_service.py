...
logger = logging.getLogger("polyguard.gemini")
...
class GeminiAIService:
    ...
    async def AI_contract_reasoning(self, source_code: str, existing_findings: List[VulnerabilityFinding]) -> Dict[str, Any]:
        ...
        prompt = f"""
        System: You are the PolyGuard v3.0 AI Security Agent specializing in Polygon Smart Contract Auditing.
        ...
        if "reentrancy" in [f.category.lower() for f in existing_findings]:
            return {
                ...
                "summary": "PolyGuard AI Agent identified critical state manipulation risks. Reentrancy flaw detected alongside potential MEV sandwich attack vectors.",
                "ai_insights": [
        ...
        return {
            ...
            "summary": "PolyGuard AI Agent verified contract logic. No critical vulnerabilities found in state transitions or access controls.",
            "ai_insights": [
