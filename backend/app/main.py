...
async def rate_limit_middleware(request: Request, call_next):
    ...
    if not allowed:
        raise HTTPException(
            ...
            detail="PolyGuard Rate Limit Exceeded. Token Bucket empty."
        )
...
async def on_startup():
    logger.info("Initializing PolyGuard v3.0 Backend Services...")
    await init_db()
    logger.info("PolyGuard v3.0 Backend initialized successfully.")
