...
class Settings(BaseSettings):
    PROJECT_NAME: str = "PolyGuard Autonomous Security Platform v3.0"
    API_V1_STR: str = "/api/v1"
    SECRET_KEY: str = os.getenv("SECRET_KEY", "polyguard-v3-super-secret-jwt-key-change-in-production")
    ...
    # Storage & Redis
    DATABASE_URL: str = os.getenv("DATABASE_URL", "sqlite+aiosqlite:///./polyguard.db")
    REDIS_URL: str = os.getenv("REDIS_URL", "redis://localhost:6379/0")
    FIREBASE_PROJECT_ID: Optional[str] = os.getenv("FIREBASE_PROJECT_ID", "polyguard-v3")
