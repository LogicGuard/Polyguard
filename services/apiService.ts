...
class PolyGuardBackendAPIService {
  ...
  async fetchAgentCrewStatus() {
    try {
      ...
      return { platform: "PolyGuard Multi-Agent Security Swarm", active_crews: [], swarm_health: 100 };
    }
  }
...
export const apiService = new PolyGuardBackendAPIService();
