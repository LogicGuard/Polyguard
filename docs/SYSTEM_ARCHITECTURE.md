# PolyGuard System Architecture Specification
...
PolyGuard is architected as a high-throughput, fault-tolerant real-time security pipeline designed to monitor, analyze, and protect smart contracts and cross-chain messaging across the Polygon AggLayer ecosystem.
...
PolyGuard integrates a specialized swarm of AI sub-agents:
